...
const normal_url = "https://www.pokellector.com/Base-Set-Expansion/";
...
async function get_info(page) {
  ...
  const textObject = (await page.evaluate((name) => name.innerText, title))
    .replace("\n", "_")
    .replace(/_#\d+/, "");
  ...
  await downloadImage(url, `./cards/${textObject}.png`);
  console.log(url);
}
